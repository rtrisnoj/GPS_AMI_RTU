...
#define NUM_PIN_DESCRIPTION_ENTRIES     (37u)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define PIN_A0					(2ul)		//PA02
#define PIN_AREF				(3ul)		//PA03
#define PIN_A1					(0ul)		//PB08
#define PIN_A2					(1ul)		//PB09
#define PIN_A3					(4ul)		//PA04
#define PIN_A4					(5ul)		//PA05
#define PIN_D10					(6ul)		//PA06
#define PIN_D11					(7ul)		//PA07

#define PIN_D0					(8ul)		//PA08
#define PIN_MILLI_WAKE			(9ul)		//PA09
#define PIN_MCU_TX				(10u)		//PA10
#define PIN_MCU_RX				(11u)		//PA11
#define PIN_USB_HOST_EN			(14u)		//PB10
#define PIN_D8					(15ul)		//PB11
#define PIN_D9					(12ul)		//PA12
#define FLASH_CS				(13u)		//PA13
//#define PIN_HOST_WAKE			() //there is not PA14 in variant.cpp
		
#define PIN_D6					(16ul)		//PA16
#define PIN_D7					(17ul)		//PA17
#define PIN_D3					(18ul)		//PA18
#define PIN_D5					(19ul)		//PA19
#define PIN_D4					(20ul)		//PA20
#define PIN_D2					(21ul)		//PA21
#define PIN_SDA					(22u)		//PA22
#define PIN_SCL					(23u)		//PA23
#define PIN_D_M					(24u)		//PA24
#define PIN_D_P					(25u)		//PA25

#define FLASH_MOSI				(32u)		//PB22
#define FLASH_SCK				(33u)		//PB23
#define PIN_X					(30u)		//NEOPIX/SWCLK (PA30)
...
#define PIN_SERIAL2_TX       (PIN_MCU_TX)				//ryan
#define PIN_SERIAL2_RX       (PIN_MCU_RX)				//ryan
#define PAD_SERIAL2_TX       (UART_TX_PAD_2)			//ryan
#define PAD_SERIAL2_RX       (SERCOM_RX_PAD_3)			//ryan
...
#define PERIPH_WIRE          sercom5
  ...
  #define WIRE_DATA_READY_HANDLER         SERCOM5_2_Handler
#else
...
#if (SAMD51)
  #define WIRE1_STOP_DETECTED_HANDLER      SERCOM1_0_Handler
  #define WIRE1_ADDRESS_MATCH_HANDLER      SERCOM1_1_Handler
  #define WIRE1_DATA_READY_HANDLER         SERCOM1_2_Handler
#else
 ...
 */
#define PIN_USB_DM                      (PIN_D_M)				//(24ul)			//RYAN
#define PIN_USB_DP                      (PIN_D_P)				//(25ul)			//RYAN
//#define PIN_USB_HOST_ENABLE             (19ul)
#define PIN_USB_HOST_ENABLE_VALUE	PIN_USB_HOST_EN				//0				//RYAN
...
//RT #define PIN_I2S_SCK         (10u)
//RT #define PIN_I2S_FS          (9u)
//RT #define PIN_I2S_SD          (11u)       // SDO (TX)
// RX (must use clock 0)
